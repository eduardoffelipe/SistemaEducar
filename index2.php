            ...
            <div class="row align-items-center">
                <div class="col-lg-6 col-sm-12 mt-lg-0 mt-4">
                    ...
                    <h3 class="mb-4">Sua<br>
                        Capacitação Online</h3>
                    <p>Com a Educar você tem um vários de cursos de capacitação EAD para se densenvolver melhor na carreira.</p>
    ...
    <section class="w3l-products py-5" id="projects">
        <div class="container py-lg-3">
            <div class="header-section text-center mx-auto">
                <span class="subhny-title text-center mb-2">Consulta rápida</span>
                <h3 class="hny-title text-center mb-5">Nossos Cursos</h3>
            </div>
            <div class="mt-5">
                <div class="mx-auto">
                    <!--Horizontal Tab-->
                                    ...
                                    foreach ($cursos as $c) {
                                            ...
                                            <div class='col-lg-12 col-sm-12 mt-12'>
                                                <div class='content mb-12'>
                                                    <a href='controllers/cursosController/cursoController.php?option=4&id=$c->idCurso'>
                                                            <div class='lte-item-descr text-center'>
                                                        <h4 class='product-title'>$c->Nome</h4>
    
                                                        <p class='mb-12'>$c->Descricao</p>
                                                    </a>
                                                </div>
                                            </div>
                                           ";
