...
if (empty($funcionario)) {
    header('Location: controllers/FuncionariosController/loadSingle.php');
}
        ...
        <div class="contacts-main py-lg-5 py-md-4">
            <div class="contant11-top-bg">
                <div class="container">
                    ...
                    <h3 class="hny-title text-center mb-md-5 mb-4">Funcionario <?= $funcionario->Funcionario?></h3>
                    <h5>CPF</h5>
                    <div class="mb-2"></div>
                    <p><?= $funcionario->CPF?></p>
                    <div class="mb-2"></div>
                    ...
                    <h5>RG</h5>
                    <div class="mb-2"></div>
                    <p><?= $funcionario->RG?>/<?= $funcionario->OrgaoEmissor?></p>
                    <div class="mb-2"></div>
                    <hr/>
                    <div class="mb-2"></div>
                    ...
                    <h5>Endereco</h5>
                    <div class="mb-2"></div>
                    <p><span style="font-weight:bold">CEP: </span><?= $funcionario->CEP?></p>
                    <p><span style="font-weight:bold">Rua: </span><?= $funcionario->Rua?>, <?= $funcionario->Numero?> - <?= $funcionario->Complemento?></p>
                    <p><span style="font-weight:bold">Bairro: </span><?= $funcionario->Bairro?></p>
                    <p><span style="font-weight:bold">Cidade: </span><?= $funcionario->Cidade?> - <?= $funcionario->Estado?></p>
                    <div class="mb-2"></div>
                    <hr/>
                    <div class="mb-2"></div>
