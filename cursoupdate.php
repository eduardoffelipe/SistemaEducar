...
if (empty($curso)) {
    header('Location: controllers/CursoController/pageUpdate.php');
}
            ...
            <div class="form-41-mian mt-5 pt-lg-5 pt-md-4">
                <div class="container">
                    <div class="form-inner-cont">
                        ...
                        <form action="./controllers/CursoController/update.php" method="post" class="signin-form" id="editForm" name="editForm">
                            <div class="d-grid align-form-map">
                                <div class="form-input">
                                  <label for="fnome">Nome*</label>
                                    <input type="text" name="fnome" id="fnome" placeholder="" value="<?php echo $curso->Nome?>" />
                                </div>
                                <div class="form-input">
                                  <label for="fidCurso">Id Curso*</label>
                                    <input type="text" name="fidCurso" id="fidCurso" placeholder="" required maxlength="200"value="<?php echo $curso->idCurso?>" />

                                </div>
                            </div>
                            <div class="form-input">
                                    <label for="fcargaHoraria">cargaHoraria*</label>
                                    <input type="text" name="fcargaHoraria" id="fcargaHoraria" placeholder="" required maxlength="200" value="<?php echo $curso->CargaHoraria?>"/>
                            <div class="form-input">
                                <label for="fdescricao">Descrição*</label>
                                <textarea placeholder="" name="fdescricao" id="fdescricao" required maxlength="400"><?php echo $curso->Descricao?></textarea>
                            </div>
                            <div class="form-input">
                                <label for="fcertificacao">Cetificacao*</label>
                                <textarea placeholder="" name="fcertificacao" id="fcertificacao" required maxlength="400"><?php echo $curso->Certificacao?></textarea>
                            </div>
                            <div class="form-input">
                                <label for="fpreRequisito">Pre Requisito*</label>
                                <textarea placeholder="" name="fpreRequisito" id="fpreRequisito" required maxlength="400"><?php echo $curso->PreRequisito?></textarea>
                            </div>
                            <div class="form-input">
                                <label for="fpublicoAlvo">Público Alvo*</label>
                                <textarea placeholder="" name="fpublicoAlvo" id="fpublicoAlvo" required maxlength="400"><?php echo $curso->PublicoAlvo?></textarea>
                            </div>

                            <div class="d-grid align-form-map">
                                <div class="form-input">
                                    <label for="fidCategoria">Id Categoria*</label>
                                    <input type="text" name="fidCategoria" id="fidCategoria" placeholder="" value="<?php echo $curso->idCategoria?>"/>
                                </div>
                                <div class="form-input">
                                    <label for="fidArea">Id Area*</label>
                                    <input type="text" name="fidArea" id="fidArea" placeholder="" required maxlength="200" value="<?php echo $curso->idArea?>"/>
